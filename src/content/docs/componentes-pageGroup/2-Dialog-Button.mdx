...
Generalmente, cuando trabajamos en el desarrollo web vamos a encontrarnos con elementos o componentes como lo son los Modales, sin embargo, estamos optando por dos alternativas a el mismo problema, usando nativamente la etiqueta `<dialog>` o usando una libreria como `tailwind` y/o `bootstrap`.


## Usando la etiqueta `<dialog>`
